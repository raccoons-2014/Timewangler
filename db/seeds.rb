...
30.times do
  Card.create(card_type: "Murok", name: historical_figure_array.pop, time_period_id: rand(1..5), description: Faker::Lorem.sentence, strength: rand(1..5), intelligence: rand(1..5), charisma: rand(1..5))
end
