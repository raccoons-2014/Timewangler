...
Card.create(card_type: "Hero", name: "Aristotle", description: "A Greek philosopher and scientist born in Stagira of Chalkidiki, next to the Macedonian Kingdom in the north part of the Greek world.", strength: 2, intelligence: 9, charisma: 5, picture_url: "http://media-2.web.britannica.com/eb-media/84/87984-004-5ADE9ACA.jpg")

Card.create(card_type: "Hero", name: "Plato", description: "Plato was a philosopher, as well as mathematician, in Classical Greece, and an influential figure in philosophy, central in Western philosophy.", strength: 3, intelligence: 8, charisma: 6, picture_url: "http://media-2.web.britannica.com/eb-media/88/149188-004-E9F3D5B9.jpg")

Card.create(card_type: "Hero", name: "Homer", description: "Best known as the author of the Iliad and the Odyssey. He was believed by the ancient Greeks to have been the first and greatest of the epic poets.", strength: 4, intelligence: 9, charisma: 7, picture_url: "http://a4.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTE4MDAzNDEwNTU4NjgyNjM4.jpg")

Card.create(card_type: "Hero", name: "Nero", description: "Roman Emperor from 54 to 68, and the last in the Julio-Claudian dynasty. Focused much of his attention on diplomacy, trade and enhancing the cultural life of the Empire. He ordered theatres built and promoted athletic games.", strength: 6, intelligence: 6, charisma: 8, picture_url: "http://media-3.web.britannica.com/eb-media/42/9842-004-614B0B53.jpg")
...
Card.create(card_type: "Hero", name: "Marcus Aurelius", description: "Was Roman Emperor from 161 to 180. He was the last of the Five Good Emperors, and is also considered one of the most important Stoic philosophers.", strength: 5, intelligence: 9, charisma: 8, picture_url: "https://maitaly.files.wordpress.com/2011/04/marcus_aurelius_bust2.jpg")
...
Card.create(card_type: "Hero", name: "Genghis Khan", description: "founder and Great Khan of the Mongol Empire, which became the largest contiguous empire in history after his demise. Totally ravaged China.", strength: 10, intelligence: 7, charisma: 9, picture_url: "http://a4.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTE4MDAzNDEwNTM0NDk5ODU0.jpg")

Card.create(card_type: "Hero", name: "Joan of Arc", description: "a heroine of France and a Roman Catholic saint. Was burned at the stake at about nineteen years of age.", strength: 7, intelligence: 6, charisma: 5, picture_url: "http://media-1.web.britannica.com/eb-media/92/60892-004-53D4AF1E.jpg")

Card.create(card_type: "Hero", name: "William the Conquerer", description: "The first Norman King of England, reigning from 1066 until his death in 1087. He launched the Norman conquest of England in 1066. The rest of his life was marked by struggles to consolidate his hold over England and his continental lands and by difficulties with his eldest son.", strength: 8, intelligence: 5, charisma: 6, picture_url: "http://a4.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTE4MDAzNDEwNzQ3ODE5NTM0.jpg")

Card.create(card_type: "Hero", name: "Kublai Khan", description: "The fifth Khagan of the Ikh Mongol Uls, reigning from 1260 to 1294, and the founder of the Yuan dynasty in Mongolia and China, a division of the Mongol Empire.", strength: 10, intelligence: 9, charisma: 8, picture_url: "http://a1.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTIwNjA4NjMzODc3MTM2OTA4.jpg")
...
Card.create(card_type: "Hero", name: "Marco Polo", description: "a Venetian merchant traveller whose travels are recorded in Livres des merveilles du monde, a book that introduced Europeans to Central Asia and China.", strength: 5, intelligence: 9, charisma: 8, picture_url: "http://a4.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTE5NDg0MDU1MTAxOTk4NjA3.jpg")
...
Card.create(card_type: "Hero", name: "Leonardo Da Vinci", description: "The supreme Renaissance painter, scientist, inventor, and polymath. Da Vinci is widely regarded as one of the greatest minds the world has ever produced.", strength: 3, intelligence: 8, charisma: 6, picture_url: "http://a5.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_300,q_80,w_300/MTIwNjA4NjMzNTM4NTEyMzk2.jpg")
...
Card.create(card_type: "Hero", name: "Christopher Columbus", description: "an Italian explorer, navigator, and colonizer, citizen of the Republic of Genoa. Under the auspices of the Catholic Monarchs of Spain, he completed four voyages across the Atlantic Ocean.", strength: 8, intelligence: 8, charisma: 7, picture_url: "http://a4.files.biography.com/image/upload/c_fill,dpr_1.0,g_face,h_320,q_80,w_300/MTI1MTQzMTAyMDUzNjg5OTg3.jpg")
