...
Card.create(card_type: "Hero", name: "Socrates", description: "A classical Greek philosopher credited as one of the founders of Western philosophy.", strength: 2, intelligence: 6, charisma: 4, picture_url: "http://philosophyforchange.files.wordpress.com/2012/04/socrates1.jpg")
...
Card.create(card_type: "Hero", name: "Plato", description: "Plato was a philosopher, as well as mathematician, in Classical Greece, and an influential figure in philosophy, central in Western philosophy.", strength: 3, intelligence: 8, charisma: 6, picture_url: "http://scienceworld.wolfram.com/biography/pics/Plato.jpg")
...
Card.create(card_type: "Hero", name: "Joan of Arc", description: "a heroine of France and a Roman Catholic saint. Was burned at the stake at about nineteen years of age.", strength: 7, intelligence: 6, charisma: 5, picture_url: "http://www.history.com/news/wp-content/uploads/2012/01/joan-of-arc.jpg")

Card.create(card_type: "Hero", name: "William the Conquerer", description: "The first Norman King of England, reigning from 1066 until his death in 1087. He launched the Norman conquest of England in 1066. The rest of his life was marked by struggles to consolidate his hold over England and his continental lands and by difficulties with his eldest son.", strength: 8, intelligence: 5, charisma: 6, picture_url: "http://www.history.com/news/history-lists/files/2013/03/hl-william-the-conqueror.jpg")
...
Card.create(card_type: "Hero", name: "William Shakespeare", description: "an English poet, playwright, and actor, widely regarded as the greatest writer in the English language and the world's pre-eminent dramatist.", strength: 4, intelligence: 7, charisma: 6, picture_url: "http://upload.wikimedia.org/wikipedia/commons/a/a2/Shakespeare.jpg")
...
Card.create(card_type: "Hero", name: "Leonardo Da Vinci", description: "The supreme Renaissance painter, scientist, inventor, and polymath. Da Vinci is widely regarded as one of the greatest minds the world has ever produced.", strength: 3, intelligence: 8, charisma: 6, picture_url: "http://www.customasapblog.com/wp-content/uploads/2011/11/da-vinci-alam_159842t.jpg")
...
Card.create(card_type: "Hero", name: "Thomas More", description: "was an English statesman who wrote an ideal political system, Utopia. He was considered a social philosopher and Renaissance humanist.", strength: 4, intelligence: 7, charisma: 5, picture_url: "http://upload.wikimedia.org/wikipedia/commons/d/d2/Hans_Holbein,_the_Younger_-_Sir_Thomas_More_-_Google_Art_Project.jpg")

Card.create(card_type: "Hero", name: "Nicholas Copernicus", description: "A mathematician and astronomer who formulated a heliocentric view of the universe. His teaching that the earth revolved around the sun placed him in opposition to the established teachings of the church.", strength: 4, intelligence: 8, charisma: 6, picture_url: "http://upload.wikimedia.org/wikipedia/commons/2/28/Copernicus.jpg")

Card.create(card_type: "Hero", name: "Galileo", description: "reating one of the first modern telescopes, Galileo revolutionised our understanding of the world supporting the work of Copernicus. His work Two New Sciences laid ground work for the science of Kinetics and strength of materials.", strength: 3, intelligence: 7, charisma: 6, picture_url: "http://upload.wikimedia.org/wikipedia/commons/d/d4/Justus_Sustermans_-_Portrait_of_Galileo_Galilei,_1636.jpg")

Card.create(card_type: "Hero", name: "Johannes Kepler", description: "German scientist who played a key role in the 17th Century scientific revolution. He created the laws of planetary motion, which influenced Sir Isaac Newton’s theory of gravitation.", strength: 3, intelligence: 8, charisma: 3, picture_url: "http://upload.wikimedia.org/wikipedia/commons/d/d4/Johannes_Kepler_1610.jpg")
...
Card.create(card_type: "Hero", name: "Donatello", description: "An Italian painter and sculptor. Donatello was a key figure in the early Florence renaissance. Major works include David, Virgin and Child with Four Angels, St Mark and The Feast of Herod.", strength: 4, intelligence: 7, charisma: 5, picture_url: "http://www.profesorenlinea.cl/imagenbiografias/donatello.jpg")
